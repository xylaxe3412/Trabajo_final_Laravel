...
Route::get('/compras/editar/{id}', [CompraController::class, 'updateCompraView'])->name('editar_compra_view');
Route::post('/compras/actualizar/{id}', [CompraController::class, 'updateCompra'])->name('update_compra');
Route::get('/compras/delete/{id}', [CompraController::class, 'deleteCompra'])->name('eliminar_compra');
Route::get('/compras/editar/{id}', [CompraController::class, 'updateCompraView'])->name('editar_compra_view');
